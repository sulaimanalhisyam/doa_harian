List<String> nama_doa = [
  "Doa sebelum makanُ",
  "Doa setelah makanُ",
  "Doa ketika makan lupa membaca doa",
  "Doa bangun tidurُ",
  "Doa ketika mendapat mimpi burukُ",
  "Doa ketika mendapat mimpi baikُ",
  "Doa masuk kamar mandi atau toilet",
  "Doa keluar kamar mandi atau toiletُ",
  "doa istinjaُ",
  "Doa menjelang sholat subuh",
  "Doa menyambut pagi hariُ",
  "Doa menyambut sore hariُ",
  "Doa ketika becerminُ",
  "Doa masuk rumah",
  "Doa keluar rumah",
  "Doa memakai pakaian",
...
List<String> arti_doa = [
  ...
  "Ya Allah, mudahkanlah kami berpergian ini, dan dekatkanlah kejauhannya. Allah yang menemani dalam berpergian, dan Engkau pula yang melindungi keluarga.",
  "Maha suci Allah yang telah menundukkan untuk kami (kendaraan) ini.  sebelumnya kami tidak mampu untuk menguasainya, dan hanya kepada-Mu lah kami akan kembali ",
  ...
  "Ya Allah, rahmatilah aku dengan Al-Quran yang agung, jadikanlah ia bagiku ikutan cahaya petunjuk rahmat. Allah, ingatkanlah apa yang telah aku lupa dan ajarkan kepadaku apa yang tidak aku ketahui darinya, anugerahkanlah padaku kesempatan membacanya pada sebagian malam dan siang, jadikanlah ia hujjah yang kuat bagiku, wahai Tuhan seru sekalian alam.",
];
